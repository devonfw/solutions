...
Without a GitHub account you can't contribute on the architecture browser.It is very simple to create an account on GitHub. 
First, you have to go to GitHub.com and you'll be greeted by the welcome page then click on "sign up",now enter your email address your password and your username. You can choose if you want or not to receive the newsletter of GitHub after to verify your account you can click on "create account" .You will receive automatically a verification email open that and click on the link,your GitHub account is now available.
...
"The repository is already on your account." -> "Please go to your fork (https://github.com/<>/architectures) and open the repository in the online IDE Gitpod." 
...
You have the possibility to create a new tutorial. Each tutorial is located in its own directory and consists of an asciidoc file, in which the tutorial is specified. 
...
To change a tutorial, select the file of this tutorial, change the content and save.
...
image::./addManual_image/tempsnip.png[cla]
