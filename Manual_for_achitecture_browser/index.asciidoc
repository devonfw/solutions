...
Note: The altenernate to Gitpod is to fork the repository, download it and modify the documents. To learn how to do this, refer the document https://github.com/firstcontributions/first-contributions#first-contributions[first contribution]
