...
YAML is supported out of the box. Scripting programming languages are supported out of the box by adding the appropriate task type. The following list describes a few standard problems that were not so obvious from the documentation:
