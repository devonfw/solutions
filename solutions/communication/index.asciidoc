...
While code first often fells more lightweight and brings less over head, for more complex project setup the formality of the contract could be very beneficial.
